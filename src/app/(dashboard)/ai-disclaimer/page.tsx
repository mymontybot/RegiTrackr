      ...
      <main className="ml-64 min-w-0 flex-1 p-6">
        ...
        <div className="mx-auto w-full max-w-3xl pb-8">
          ...
          <section>
            ...
            <p className="mt-3 text-sm leading-relaxed text-slate-400">
              RegiTrackr maintains a database of economic nexus thresholds by state. This database is reviewed
              quarterly against official state revenue department sources. However, states may change thresholds,
              effective dates, or rules at any time. Always verify current thresholds directly with the relevant state
              revenue department before advising a client.
            </p>
          </section>
