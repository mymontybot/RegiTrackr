...
export const metadata = {
  title: "AI Disclaimer — RegiTrackr",
  description:
    "How the AI Nexus Exposure Narrative works and what it does not do. Informational use only, not tax advice.",
};

export default function AiDisclaimerPublicPage() {
    ...
    <div className="mx-auto max-w-3xl px-4 py-24 sm:px-6 lg:px-8">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-400">
              The AI Nexus Exposure Narrative is an automated summary of data you have entered into RegiTrackr. It is
              provided for informational and workflow purposes only. It does not constitute tax advice, legal advice, or
              a compliance opinion. Always verify threshold data, deadlines, and registration requirements directly with
              official state revenue department sources before taking action.
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <p className="mt-3 text-sm leading-relaxed text-slate-400">
          The goal is to give CPA firm staff a fast, readable briefing on a client's position without requiring them to
          manually review every data point in the dashboard.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-6 text-sm leading-relaxed text-slate-400">
          ...
          <li>
            Account for product-specific exemptions, industry-specific rules, or multi-factor nexus tests that are not
            captured in the data entered into RegiTrackr
          </li>
          <li>Constitute a compliance opinion, legal opinion, or tax advice of any kind</li>
        </ul>
        <p className="mt-3 text-sm leading-relaxed text-slate-400">
          The CPA firm and its licensed professionals remain solely responsible for all compliance determinations and
          filings made on behalf of their clients.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-sm leading-relaxed text-slate-400">
          Each narrative is generated using a large language model (LLM) provided by Anthropic. The model is given a
          structured prompt containing the client's current data from RegiTrackr and instructed to produce a factual
      ...
      <section>
        ...
        <p className="text-sm leading-relaxed text-slate-400">
          The accuracy of the AI Narrative depends entirely on the accuracy of the data entered into RegiTrackr. If
          revenue figures, registration statuses, or filing records are incomplete or incorrect, the narrative will
          reflect that.
        </p>
        <p className="mt-3 text-sm leading-relaxed text-slate-400">
      ...
      <section>
        ...
        <ul className="mt-2 list-disc space-y-1 pl-6 text-sm leading-relaxed text-slate-400">
          ...
          <li>
            The model may occasionally produce phrasing that implies more certainty than the underlying data warrants.
            CPA professionals should apply their own judgment when interpreting any narrative.
          </li>
          <li>
            Narratives are not reviewed by a licensed tax professional before delivery. They are automated outputs.
          </li>
          <li>
            Enterprise-specific rules, treaty overrides, or unusually complex multi-state structures may not be fully
            captured in a brief narrative format.
          </li>
        </ul>
      </section>
